...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar w-full bg-background p-3 [--cell-radius:var(--radius-md)] [--cell-size:2.5rem] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative rounded-(--cell-radius) border border-input bg-background px-2 py-1",
          defaultClassNames.dropdown_root
        ),
        dropdown: cn(
          "absolute inset-0 z-10 size-full cursor-pointer bg-popover opacity-0",
        ...
        weekday: cn(
          "h-10 w-[14.285714%] rounded-(--cell-radius) text-center text-sm font-medium text-muted-foreground select-none",
        ...
        day: cn(
          "group/day relative h-(--cell-size) w-[14.285714%] rounded-(--cell-radius) p-0 text-center align-middle select-none [&:last-child[data-selected=true]_button]:rounded-e-(--cell-radius)",

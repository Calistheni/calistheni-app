    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        onOpenAutoFocus={(event) => {
          ...
          // Do not let a newly opened dialog focus its first text field. The
          // dialog itself is a safe, keyboard-accessible initial focus target.

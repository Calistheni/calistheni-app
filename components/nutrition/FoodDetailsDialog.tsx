...
type SearchFood = { id?: string; provider?: "USDA" | "OPEN_FOOD_FACTS"; externalId: string; name: string; isLocal?: boolean; genericIcon?: { key: string; url: string } | null };
type Serving = { id: string; name: string; grams: number };
type FoodDetail = {
  name: string; brandName: string | null; genericIcon: { key: string; url: string } | null; images: { front: string | null; nutrition: string | null; ingredients: string | null }; package: { quantityText: string | null }; servings: Serving[];

...
export function MeasurementTracker({ isPro, initialBodyFatSex, initialHeightCm }: { isPro: boolean; initialBodyFatSex: BodyFatSex | null; initialHeightCm: string | null }) {
  ...
  function openDialog() {
    ...
    setValues(next); setInitialValues(next); setClearFields([]); setNote(latestNote); setInitialNote(latestNote); setErrors({}); setRequestError(null); setOpen(true);
  }

  ...
  assert.deepEqual(activity, [
    {
      ...
      totalVolumeKg: 80,
      workouts: [
        { id: "2026-07-15-1", name: "Workout", completedAt: "2026-07-15T08:00:00.000Z" },
      ],
    },
    {
      date: "2026-07-16",
      ...
      totalVolumeKg: 120,
      workouts: [
        { id: "2026-07-16-1", name: "Workout", completedAt: "2026-07-16T08:00:00.000Z" },
        { id: "2026-07-16-2", name: "Workout", completedAt: "2026-07-16T20:00:00.000Z" },
      ],
    },
  ]);
});

test("activity calendar range matches the rendered UTC grid boundaries", () => {
  const range = getTrainingActivityCalendarRange("2026-08-04T22:30:00.000Z");

  assert.equal(range.start.toISOString(), "2026-02-09T00:00:00.000Z");
  assert.equal(range.end.toISOString(), "2026-08-10T00:00:00.000Z");
});

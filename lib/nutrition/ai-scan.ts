...
export const aiMealScanJsonSchema = {
  type: "object", additionalProperties: false, required: ["foods", "notes"], properties: {
    foods: { type: "array", maxItems: 20, items: { type: "object", additionalProperties: false, required: ["label", "preparation", "estimatedGrams", "quantityText", "confidence"], properties: { label: { type: "string" }, preparation: { anyOf: [{ type: "string" }, { type: "null" }] }, estimatedGrams: { anyOf: [{ type: "number" }, { type: "null" }] }, quantityText: { anyOf: [{ type: "string" }, { type: "null" }] }, confidence: { type: "number" } } } },

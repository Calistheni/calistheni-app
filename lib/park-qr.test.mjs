...
test("QR notes are optional, edge-trimmed, and limited to 200 characters", () => {
  ...
  assert.equal(normalizeParkQrNote("x".repeat(200)), "x".repeat(200));
  assert.equal(normalizeParkQrNote("x".repeat(201)), undefined);
